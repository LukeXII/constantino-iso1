...
#define GPIO_BUTTON_1       GPIO_PIN_14
#define PORT_BUTTON_1       GPIOD
#define EXIT_BUTTON_1       B1_EXTI_IRQn

#define GPIO_BUTTON_2       GPIO_PIN_15
#define PORT_BUTTON_2       GPIOD
#define EXIT_BUTTON_2       B2_EXTI_IRQn

#define GPIO_LED_RED        LD3_Pin
#define PORT_LED_RED        LD3_GPIO_Port

#define GPIO_LED_GREEN		GPIO_PIN_0
#define PORT_LED_GREEN		GPIOC

#define GPIO_LED_BLUE       LD2_Pin
#define PORT_LED_BLUE       LD2_GPIO_Port

#define GPIO_LED_YELLOW		GPIO_PIN_3
#define PORT_LED_YELLOW		GPIOC

#define GPIO_LED_HEARBEAT   LD1_Pin
#define PORT_LED_HEARBEAT   LD1_GPIO_Port
